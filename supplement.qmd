...
During the first 20 years from 1985-2005, the species overall population was generally stable. The model estimated an overall change in the population of approximately `r paste(chtotal)`. Trends varied among routes and regions (Figure 1). The effect of habitat on mean relative abundance was strong and positive ($P_{\alpha_{r}}$ = `r paste(hab_eff)`), if the residual trend was modeled without the spatial-dependency. However, when the spatial dependency was included, most of the variation in the relative abundance was allocated to the spatial component. There was a positive effect of change in the habitat suitability on trends, such that routes with habitat-loss had more negative population trends. However, this effect was somewhat uncertain $P_{\beta_{r}}$ = `r paste(hab_slope)`, and 0 was included within the 95% posterior credible interval.
